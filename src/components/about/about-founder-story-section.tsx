        ...
        <Reveal delay={0.08}>
          <div className="mt-10 flex gap-6">
            ...
            <blockquote className="max-w-4xl text-3xl italic leading-[1.6] text-[var(--foreground)] sm:text-4xl">
              “{page?.storyQuote || "Healing became personal before it ever became professional."}”
            </blockquote>
          </div>
        </Reveal>
